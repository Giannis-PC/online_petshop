<html>
<!--- Φόρμα "Αποστολή & Πληρωμή" όταν ο χρήστης δεν είναι συνδεδεμένος. --->
	...
	<!--- Στοιχεία Πελάτη --->
		...
		<div class="d-block mb-3">
			<div class="custom-control custom-radio">
				<input id="local" name="delivery" type="radio" class="custom-control-input">
		...
		<div class="d-block mb-3">
			<div class="custom-control custom-radio">
				<input id="card_payment" name="paymentMethod" type="radio" class="custom-control-input">
